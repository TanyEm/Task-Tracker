...
class TasksListTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let attributes = [NSAttributedString.Key.font:UIFont(name: "SF Compact Rounded Medium", size: 19)!]
        self.editButtonItem.setTitleTextAttributes(attributes, for: .normal)
